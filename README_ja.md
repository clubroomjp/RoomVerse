...
- **日英両対応**: 日本語（例: エクスカリバー）と英語（Example: Excalibur）の両方のキーワードに対応。LLMの理解を助けるため、エントリは自動的に英語に翻訳されます。
- **ビジターによる学習**: ビジターは `!learn` コマンドやチャット画面の「Teach」ボタンを使って、AIに新しい言葉を教えることができます。

### 🗣️ リアルタイム翻訳
- **チャット翻訳**: 送受信されるメッセージを、設定した言語に自動翻訳します。
